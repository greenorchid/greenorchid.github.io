...
A novel addition to our structure is the **Capability Owner**. Unlike an EM who manages people, or a PO who manages a product, the Capability Owner owns the *standards* of a specific domain (e.g., SRE, Engineering, Product).
